...
"brightspec": {"title": "BrightSpec MCAs", "productLine": "BrightSpec MCAs", "lede": "Compare the line at a glance and open any datasheet. Click any column heading to sort. Select models to compare them side by side or request a quote.", "dsbase": "https://www.berkeleynucleonics.com/", "columns": [{"key": "detectors", "label": "Detectors"}, {"key": "channels", "label": "Channels"}, {"key": "interface", "label": "Interface"}, {"key": "form", "label": "Form factor"}], "models": [{"num": 1, "model": "Topaz-SiPM", "sum": "Miniature MCA for SiPM scintillation detectors", "ds": "figures/brightspec/topaz-sipm-datasheet.pdf", "vals": {"detectors": "NaI(Tl), CsI(Tl), LaBr3, CeBr3 (SiPM)", "channels": "4096", "interface": "USB", "form": "Miniature"}, "sort": {"detectors": 0, "channels": 4096, "interface": 0, "form": 1}}, {"num": 2, "model": "Topaz-HR", "sum": "High-resolution MCA for HPGe, CZT, Si(Li), SDD, PIPS", "ds": "figures/brightspec/topaz-hr-datasheet.pdf", "vals": {"detectors": "HPGe, CdZnTe, Si(Li), SDD, PIPS", "channels": "16384", "interface": "USB / Ethernet", "form": "Compact"}, "sort": {"detectors": 0, "channels": 16384, "interface": 0, "form": 2}}, {"num": 3, "model": "TOPAZ-Pico", "sum": "Portable stand-alone digital MCA", "ds": "https://www.brightspec.be/brightspec/?q=node/24", "vals": {"detectors": "NaI(Tl), CsI(Tl), LaBr3, CeBr3, SrI2, BGO, plastic", "channels": "4096", "interface": "USB", "form": "Portable"}, "sort": {"detectors": 0, "channels": 4096, "interface": 0, "form": 1}}, {"num": 4, "model": "bPAD", "sum": "Single-channel analyzer in a PMT base", "ds": "https://www.brightspec.be/brightspec/?q=node/13", "vals": {"detectors": "NaI(Tl), CsI(Tl), LaBr3, CeBr3, SrI2, BGO, plastic", "channels": "1 (SCA)", "interface": "Analog", "form": "PMT base"}, "sort": {"detectors": 0, "channels": 1, "interface": 0, "form": 0}}, {"num": 5, "model": "bMCA-USB", "sum": "Plug-on digital MCA, direct PC link", "ds": "https://www.brightspec.be/brightspec/?q=node/11", "vals": {"detectors": "14-pin PMT scintillators", "channels": "—", "interface": "USB", "form": "Plug-on"}, "sort": {"detectors": 0, "channels": 0, "interface": 0, "form": 1}}, {"num": 6, "model": "bMCA-Ethernet", "sum": "Plug-on digital MCA, network-connected", "ds": "https://www.brightspec.be/brightspec/?q=node/12", "vals": {"detectors": "14-pin PMT scintillators", "channels": "—", "interface": "Ethernet", "form": "Plug-on"}, "sort": {"detectors": 0, "channels": 0, "interface": 0, "form": 1}}, {"num": 7, "model": "bGamma", "sum": "Gamma spectroscopy analysis software", "ds": "brightspec-bgamma.html", "vals": {"detectors": "—", "channels": "—", "interface": "Windows / Linux / macOS", "form": "Software"}, "sort": {"detectors": 0, "channels": 0, "interface": 0, "form": 0}}, {"num": 8, "model": "FLINT", "sum": "Integrated SiPM probe with digital MCA", "ds": "brightspec-flint.html", "vals": {"detectors": "NaI(Tl) 2x2/3x3 (SiPM)", "channels": "4096", "interface": "USB", "form": "Integrated probe"}, "sort": {"detectors": 0, "channels": 4096, "interface": 0, "form": 3}}]},
"spectechniques": {"title": "SpecTechniques Radiation Check Sources", "productLine": "SpecTechniques Radiation Check Sources", "lede": "Compare the line at a glance and open any datasheet. Click any column heading to sort. Select models to compare them side by side or request a quote.", "dsbase": "https://www.berkeleynucleonics.com/", "columns": [{"key": "sources", "label": "Sources in Set"}, {"key": "isotopes", "label": "Isotopes"}, {"key": "activity", "label": "Typical Activity"}, {"key": "cert", "label": "Certification"}], "models": [{"num": 2, "model": "RSS2", "sum": "GM resolving-time set (3 half-disks)", "ds": "spectechniques-home.html#kits", "vals": {"sources": "3 half-disks (2 active, 1 blank)", "isotopes": "Tl-204", "activity": "5 uCi (185 kBq); EU 0.25 uCi", "cert": "+/-20% of labeled"}, "sort": {"sources": 3, "isotopes": 1, "activity": 5, "cert": 20}}, {"num": 3, "model": "RSS3", "sum": "Alpha / beta / gamma demonstration set", "ds": "spectechniques-home.html#kits", "vals": {"sources": "3 disks (1 alpha, 1 beta, 1 gamma)", "isotopes": "Co-60, Sr-90, Po-210", "activity": "0.1 to 1 uCi (3.7 to 37 kBq)", "cert": "+/-20% of labeled"}, "sort": {"sources": 3, "isotopes": 3, "activity": 1, "cert": 20}}, {"num": 5, "model": "RSS5", "sum": "Alpha / beta / gamma set (5 sources)", "ds": "spectechniques-home.html#kits", "vals": {"sources": "5 disks (1 alpha, 2 beta, 2 gamma)", "isotopes": "Co-60, Cs-137, Tl-204, Sr-90, Po-210", "activity": "0.1 to 5 uCi (3.7 to 185 kBq)", "cert": "+/-20% of labeled"}, "sort": {"sources": 5, "isotopes": 5, "activity": 5, "cert": 20}}, {"num": 8, "model": "RSS8", "sum": "Gamma spectroscopy set, 32 keV to 1332 keV", "ds": "spectechniques-home.html#kits", "vals": {"sources": "8 gamma disks (incl. mixed unknown)", "isotopes": "Ba-133, Cd-109, Co-57, Co-60, Cs-137, Eu-152, Na-22", "activity": "0.5 to 1 uCi (18.5 to 37 kBq)", "cert": "+/-20%, +/-5% option"}, "sort": {"sources": 8, "isotopes": 8, "activity": 1, "cert": 5}}]},
"megiq": {"title": "MegiQ VNAs & Antenna Measurement", "productLine": "MegiQ VNAs & Antenna Measurement", "lede": "Compare the line at a glance and open any datasheet. Click any column heading to sort. Select models to compare them side by side or request a quote.", "dsbase": "https://www.berkeleynucleonics.com/", "columns": [{"key": "freq", "label": "Frequency"}, {"key": "ports", "label": "Ports"}, {"key": "type", "label": "Type"}], "models": [{"num": 1, "model": "VNA-0460EBN", "sum": "6 GHz 3-port vector network analyzer", "ds": "figures/megiq/megiq-vna-datasheet.pdf", "vals": {"freq": "400 MHz - 6 GHz", "ports": "3", "type": "VNA"}, "sort": {"freq": 6, "ports": 3, "type": 1}}, {"num": 2, "model": "VNA-0460BN", "sum": "6 GHz 2-port vector network analyzer", "ds": "figures/megiq/megiq-vna-datasheet.pdf", "vals": {"freq": "400 MHz - 6 GHz", "ports": "2", "type": "VNA"}, "sort": {"freq": 6, "ports": 2, "type": 1}}, {"num": 3, "model": "VNA-0440EBN", "sum": "4 GHz 3-port vector network analyzer", "ds": "figures/megiq/megiq-vna-datasheet.pdf", "vals": {"freq": "400 MHz - 4 GHz", "ports": "3", "type": "VNA"}, "sort": {"freq": 4, "ports": 3, "type": 1}}, {"num": 4, "model": "VNA-0440BN", "sum": "4 GHz 2-port vector network analyzer", "ds": "figures/megiq/megiq-vna-datasheet.pdf", "vals": {"freq": "400 MHz - 4 GHz", "ports": "2", "type": "VNA"}, "sort": {"freq": 4, "ports": 2, "type": 1}}, {"num": 5, "model": "AMS-0660BN", "sum": "600 MHz - 6 GHz antenna measurement system", "ds": "figures/megiq/megiq-ams-datasheet.pdf", "vals": {"freq": "600 MHz - 6 GHz", "ports": "—", "type": "Antenna Meas."}, "sort": {"freq": 6, "ports": 0, "type": 2}}, {"num": 6, "model": "AMS-0640BN", "sum": "600 MHz - 4 GHz antenna measurement system", "ds": "figures/megiq/megiq-ams-datasheet.pdf", "vals": {"freq": "600 MHz - 4 GHz", "ports": "—", "type": "Antenna Meas."}, "sort": {"freq": 4, "ports": 0, "type": 2}}, {"num": 7, "model": "AMS-0460BN", "sum": "370 MHz - 6 GHz antenna measurement system", "ds": "figures/megiq/megiq-ams-datasheet.pdf", "vals": {"freq": "370 MHz - 6 GHz", "ports": "—", "type": "Antenna Meas."}, "sort": {"freq": 6, "ports": 0, "type": 2}}, {"num": 8, "model": "AMS-0440BN", "sum": "370 MHz - 4 GHz antenna measurement system", "ds": "figures/megiq/megiq-ams-datasheet.pdf", "vals": {"freq": "370 MHz - 4 GHz", "ports": "—", "type": "Antenna Meas."}, "sort": {"freq": 4, "ports": 0, "type": 2}}]},
"medusa": {"title": "Medusa Environmental Radiometrics", "productLine": "Medusa Environmental Radiometrics", "lede": "Compare the line at a glance and open any datasheet. Click any column heading to sort. Select models to compare them side by side or request a quote.", "dsbase": "https://www.berkeleynucleonics.com/", "columns": [{"key": "detector", "label": "Detector"}, {"key": "application", "label": "Application"}, {"key": "platform", "label": "Platform"}], "models": [{"num": 1, "model": "MS-350", "sum": "Drone-based gamma-ray detection & identification", "ds": "https://www.berkeleynucleonics.com/figures/medusa/medusa-drone-detectors-datasheet.pdf", "vals": {"detector": "CsI(Tl) gamma, full-spectrum", "application": "Radiometric survey & isotope ID", "platform": "Hand-held / DJI M250 RTK drone"}, "sort": {"detector": 1, "application": 1, "platform": 2}}, {"num": 2, "model": "RhoC 5", "sum": "Soil bulk density measurement system", "ds": "https://www.berkeleynucleonics.com/figures/medusa/rhoc-5-datasheet.pdf", "vals": {"detector": "Density gauge (in-situ)", "application": "Soil bulk density mapping", "platform": "Portable field gauge"}, "sort": {"detector": 2, "application": 2, "platform": 1}}]},
"pdg": {
...
"rfsg": {
  ...
  models: [
   ...
   {num:4220, model:"RFS-4220", sum:"22 GHz benchtop, touchscreen + LAN", ds:"bnc-rfs-4220-datasheet.html",
    vals:{type:"Signal Generator",freq:"0.1 to 22 GHz",channels:"1",switch:"—",power:"-40 to +15 dBm"},
...
"hvx": {
  ...
  models: [
   {num:1, model:"HVX-1500-2000", sum:"1.5 kV high-current, 2 A", ds:"bnc-hvx-hv-power-supply-manual.html",
   ...
   {num:2, model:"HVX-1500-1400", sum:"1.5 kV floating high-current", ds:"bnc-hvx-hv-power-supply-manual.html",
   ...
   {num:3, model:"HVX-5000-600", sum:"5 kV mid-voltage workhorse", ds:"bnc-hvx-hv-power-supply-manual.html",
    vals:{voltage:"5 kV",current:"600 mA",power:"3 kW",polarity:"Pos / neg / reversible"}, sort:{voltage:5,current:600,power:3000,polarity:2}},
   {num:4, model:"HVX-5000-400", sum:"5 kV reversible HV test", ds:"bnc-hvx-hv-power-supply-manual.html",
    vals:{voltage:"5 kV",current:"400 mA",power:"2 kW",polarity:"Pos / neg / reversible"}, sort:{voltage:5,current:400,power:2000,polarity:2}},
   {num:5, model:"HVX-10000-300", sum:"10 kV characterization supply", ds:"bnc-hvx-hv-power-supply-manual.html",
   ...
   {num:6, model:"HVX-10000-200", sum:"10 kV reversible bench source", ds:"bnc-hvx-hv-power-supply-manual.html",
   ...
   {num:7, model:"HVX-20000-25", sum:"20 kV precision HV reference", ds:"bnc-hvx-hv-power-supply-manual.html",
   ...
   {num:8, model:"HVX-30000-17", sum:"30 kV breakdown and charging", ds:"bnc-hvx-hv-power-supply-manual.html",
  ...
  function initWidget(mount, cfg){
    ...
    // Model link: honor an absolute-URL ds (partner supplier/datasheet); otherwise prefix
    // the datasheet base. Open external links and PDFs in a new window.
    function dsHref(m){ return /^https?:/i.test(m.ds) ? m.ds : DSBASE+m.ds; }
    function dsTgt(m){ return (/^https?:/i.test(m.ds) || /\.pdf(\?|#|$)/i.test(m.ds)) ? ' target="_blank" rel="noopener"' : ''; }
    ...
    q('.cmpBtn').addEventListener('click',function(){ var ms=selectedModels().slice(0,CMP_MAX);
      var head='<thead><tr><th>Spec</th>'+ms.map(function(m){return '<th><a href="'+dsHref(m)+'"'+dsTgt(m)+' style="color:var(--accent);text-decoration:none">'+esc(m.model)+'</a><div style="font-weight:400;color:var(--muted);font-size:12px">'+esc(m.sum)+'</div></th>';}).join('')+'</tr></thead>';
      ...
      var dsrow='<tr><td>Datasheet</td>'+ms.map(function(m){return '<td><a href="'+dsHref(m)+'"'+dsTgt(m)+' style="color:var(--accent)">Open &rarr;</a></td>';}).join('')+'</tr>';
