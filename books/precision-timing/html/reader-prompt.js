...
(function () {
  ...
  var BOOK_KEY = "tmi";
  var PATHS_SENTENCE = "This book has three reading paths: one for engineers new to pulse generators, one for the operator at the bench, and one for the integrator wiring a pulser into a larger system. A quick six-question quiz will point you to the right chapters and send a personalized roadmap.";
