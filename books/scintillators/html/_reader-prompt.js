...
(function () {
  ...
  var SKIP_KEY = "scintillator-reader-prompt-skip-until";
  var TAKEN_KEY = "scintillator-reader-prompt-taken";
  var SKIP_DAYS = 30;
    ...
    ov.innerHTML =
      '<div class="bnc-rp-modal" style="position:relative;">' +
        ...
        '<div class="bnc-rp-body">' +
          '<p>This book has three reading paths depending on whether you\'re learning the field, picking a detector for a project, or designing custom hardware. A quick six-question quiz will give you a personalized roadmap.</p>' +
          '<div class="perks">' +
