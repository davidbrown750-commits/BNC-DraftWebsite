...
(function () {
  ...
  var BOOK_KEY = "radar";
  var PATHS_SENTENCE = "This book has three reading paths: a newcomer's path through the history and fundamentals, a systems engineer's path through the equations, bands, and antennas, and a test-and-measurement path through transmitters, tubes, and waveform generation. A quick six-question quiz will give you a personalized roadmap.";
