 ...
 *   BOOK_KEY       - unique slug (scintillator/rtsa/hppg/rfpower/riid/radar/rf/awg)
...
(function () {
  ...
  var BOOK_KEY = "awg";
  var PATHS_SENTENCE = "This book reads three ways: a newcomer path through the theory and vocabulary of arbitrary waveform generation, a buyer path that matches the instrument to your signal and budget, and an engineer path that goes deep on sampling fidelity, sequencing, modulation, and multi-channel synchronization. A quick six-question quiz will point you to the right one.";
