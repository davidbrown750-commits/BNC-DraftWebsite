...
(function () {
  ...
  var SKIP_KEY = "rf-reader-prompt-skip-until";
  var TAKEN_KEY = "rf-reader-prompt-taken";
  var SKIP_DAYS = 30;
    ...
    ov.innerHTML =
      '<div class="bnc-rp-modal" style="position:relative;">' +
        ...
        '<div class="bnc-rp-body">' +
          '<p>This book has three reading paths depending on whether you\'re learning RF measurement, choosing instruments for a test project, or designing and validating RF hardware. A quick six-question quiz will give you a personalized roadmap.</p>' +
          '<div class="perks">' +
