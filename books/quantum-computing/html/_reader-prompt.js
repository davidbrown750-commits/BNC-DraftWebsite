/* _reader-prompt.js
 *
 * Drops a top "Reader Path / Free Print Copy" banner at the top of any
 * chapter HTML, and shows a modal prompt 30 seconds after page load
 * inviting the reader to take the routing quiz. Skip dismisses for 30 days.
 *
 * Usage: add  <script defer src="_reader-prompt.js"></script>  to each
 * chapter HTML's <head> (the inject_reader_prompt.py script does this).
 */
(function () {
  // --- config --------------------------------------------------------------
  var QUIZ_URL = "../web/reader-quiz.html"; // book/html/* -> book/web/reader-quiz.html
  var DELAY_MS = 30 * 1000;
  var SKIP_KEY = "qc-reader-prompt-skip-until";
  var TAKEN_KEY = "qc-reader-prompt-taken";
  var SKIP_DAYS = 30;
    ...
    ov.innerHTML =
      '<div class="bnc-rp-modal" style="position:relative;">' +
        ...
        '<div class="bnc-rp-body">' +
          '<p>This book has three reading paths depending on whether you\'re learning quantum computing, evaluating it for a project or organization, or building and researching quantum systems. A quick six-question quiz will give you a personalized roadmap.</p>' +
          '<div class="perks">' +
  ...
  function maybeShowAfterDelay() {
    ...
    setTimeout(function () {
      if (isDismissed()) return; // double-check (might have taken on another tab)
