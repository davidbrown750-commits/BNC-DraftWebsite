...
(function () {
  ...
  var BOOK_KEY = "rfpower";
  var PATHS_SENTENCE = "This book reads three ways: a newcomer path through the physics and vocabulary, a buyer path that matches the instrument and sensor to your signal, and an engineer path that goes deep on accuracy, pulse profiling, and statistical analysis. A quick six-question quiz will point you to the right one.";
